...
public class ProductViewActivity extends BaseActivity {
    ...
    String _id, _title, _image, _description, _price, _currency, _discount, _attribute,_mart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _mart = intent.getStringExtra("mart");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(ProductViewActivity.this, CustomerDashboardActivity.class);
